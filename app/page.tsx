...
function Button({ className, variant = "primary", ...props }: ButtonProps) {
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F0C040] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A]",
        variant === "primary" &&
        ...
        variant === "outline" &&
          "border border-zinc-700 bg-zinc-900/40 text-zinc-200 hover:border-[#F0C040]/70 hover:text-[#F0C040]",
        className,
      )}
      {...props}
    />
...
function Card({ className, ...props }: CardProps) {
  return (
    <div
      className={cn(
        "rounded-2xl border border-zinc-800 bg-[#1A1A1A]/90 p-6 shadow-[0_14px_35px_-24px_rgba(0,0,0,0.95)] backdrop-blur-md transition-all duration-300",
        className,
      )}
      {...props}
    />
...
function FeatureCard({
  ...
  return (
    <Card className="group border-zinc-800/95 hover:-translate-y-1 hover:border-[#F0C040]/60 hover:shadow-[0_24px_48px_-34px_rgba(240,192,64,1)]">
...
function Step({
  ...
  return (
    <Card className="h-full border-zinc-800/90 p-5 hover:border-[#F0C040]/55">
...
export default function Home() {
  return (
    <main className="relative overflow-x-clip bg-[#0A0A0A] text-zinc-100 transition-colors duration-500 dark:bg-[#0A0A0A]">
      <Navbar />

      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-56 left-1/2 h-136 w-136 -translate-x-1/2 rounded-full bg-[#F0C040]/16 blur-3xl" />
        ...
        <div className="absolute bottom-0 left-[-9%] h-80 w-80 rounded-full bg-zinc-700/20 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-30 md:px-8 md:pt-36">
        ...
        >
          <div className="animate-[fade-in_0.7s_ease-out]">
            ...
            <div className="mt-8 flex items-center gap-7 text-sm text-zinc-400">
          ...
          <Card className="animate-[slide-in_0.8s_ease-out] border-zinc-800 p-4">
            ...
            <Card className="mt-4 bg-zinc-900/80 p-4">
              ...
              <div className="h-32 rounded-xl bg-[linear-gradient(120deg,rgba(240,192,64,0.35),rgba(240,192,64,0.08)_40%,rgba(255,255,255,0.03))]" />
            </Card>
            <Card className="mt-4 bg-zinc-900/80 p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between rounded-lg bg-zinc-800/70 px-3 py-2">
                  <span className="text-zinc-300">US Election Winner</span>
                  <span className="font-semibold text-zinc-100">18.2%</span>
                </div>
                <div className="flex items-center justify-between rounded-lg bg-zinc-800/70 px-3 py-2">
                  <span className="text-zinc-300">Fed Rate Cut Q3</span>
                  <span className="font-semibold text-zinc-100">14.7%</span>
                </div>
              </div>
            </Card>
          </Card>
        ...
        <section id="ai-analysis" className="pb-24">
          ...
          />
          <Card className="mx-auto mt-10 max-w-4xl border-[#F0C040]/55 bg-[#1A1A1A] p-6 shadow-[0_0_0_1px_rgba(240,192,64,0.3),0_26px_60px_-34px_rgba(240,192,64,0.9)]">
            <div className="mb-4 flex items-center gap-2 text-sm font-medium text-zinc-200">
              <BrainCircuit className="size-4 text-[#F0C040]" />
              AI Analyst Output
            </div>
            <div className="rounded-xl border border-zinc-800 bg-zinc-950/80 p-5 text-sm leading-relaxed text-zinc-300">
          ...
          <Card className="border-zinc-800 p-4">
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[1.3fr_1fr]">
              <Card className="bg-zinc-900/85 p-4">
                ...
                <div className="h-40 rounded-xl bg-[radial-gradient(circle_at_top_left,rgba(240,192,64,0.28),transparent_45%),linear-gradient(130deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]" />
              </Card>
              <Card className="bg-zinc-900/85 p-4">
                <p className="mb-3 text-sm text-zinc-400">Open Markets</p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between rounded-lg bg-zinc-800/70 px-3 py-2">
                    <span className="text-zinc-300">Politics</span>
                    <span className="font-semibold text-zinc-100">21</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-zinc-800/70 px-3 py-2">
                    <span className="text-zinc-300">Macro</span>
                    <span className="font-semibold text-zinc-100">34</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-zinc-800/70 px-3 py-2">
                    <span className="text-zinc-300">Sports</span>
                    <span className="font-semibold text-zinc-100">17</span>
                  </div>
                </div>
              </Card>
            </div>
        ...
        <section className="pb-20">
          <Card className="border-[#F0C040]/45 bg-zinc-950 p-10 text-center shadow-[0_24px_65px_-36px_rgba(240,192,64,0.95)]">
            <h3 className="text-3xl font-semibold text-zinc-100 md:text-4xl">
